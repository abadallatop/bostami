...
export default function HeaderTwo() {
  ...
  return (
    <div className="sk-header-area mb-80 z-index-5">
      <div className="container">
        <div className="sk-header-wrap main-style-2">
          <div className="row">
            ...
            <div className="col-lg-10 col-md-6 col-sm-8 col-8">
              <div className="header-right-flex">
                ...
                <div className="sk-header-menu-btn text-right ml-30">
                  <div
